...
(function () {
    ...
    et.__super__.constructor.apply(this, arguments),
      (t = function (t) {
        ...
        return (t.open = function (n, s, o) {
          return (
            M(n) && e.trigger("request", { type: n, url: s, request: t }),
            i.apply(t, arguments)
          );
        });
      }),
  ...
  V(J, (U = Error)),
    ...
    (x = function () {
      ...
      var i,
        ...
        o = t.url;
      if (!O(o))
        return r.running || (!1 === E.restartOnRequestAfter && "force" !== M(n))
          ? void 0
          : ((i = arguments),
  ...
  (function (t, e) {
    ...
    var C = (function (t) {
      ...
      try {
        M.apply((I = N.call(w.childNodes)), w.childNodes),
        ...
        function (t, e) {
          w.fn[t] = function (i, n) {
            ...
            return (
              ...
              1 < this.length &&
                (M[t] || w.uniqueSort(s), O.test(t) && s.reverse()),
              this.pushStack(s)
            );
          };
        }
          ...
          (t.fn.position = function (s) {
            ...
            return (
              ...
              this.each(function () {
                ...
                "right" === s.my[0]
                  ? (T.left -= h)
                  : "center" === s.my[0] && (T.left -= h / 2),
                  "bottom" === s.my[1]
                    ? (T.top -= c)
                    : "center" === s.my[1] && (T.top -= c / 2),
                  (T.left += D[0]),
                  (T.top += D[1]),
                  (n = { marginLeft: d, marginTop: v }),
                  t.each(["left", "top"], function (e, i) {
                    t.ui.position[w[e]] &&
                      t.ui.position[w[e]][i](T, {
                        targetWidth: p,
                        targetHeight: f,
                        elemWidth: h,
                        elemHeight: c,
                  ...
                  s.using &&
                    (a = function (t) {
                      ...
                      h > p && p > r(e + i) && (u.horizontal = "center"),
                        c > f && f > r(n + a) && (u.vertical = "middle"),
                        (u.important =
                          o(r(e), r(i)) > o(r(n), r(a))
                            ? "horizontal"
                            : "vertical"),
          ...
          for (
            ...
            for (C = "", this.maxRows = 4, k = 0; U[1] > k; k++) {
              if (
                ...
                if (((E += "<div class='ui-datepicker-group"), U[1] > 1))
                  switch (k) {
                    case 0:
              ...
              for (
                E += S + "</tr></thead><tbody>",
                  ...
                  O = Math.ceil((P + I) / 7),
                  M = V && this.maxRows > O ? this.maxRows : O,
                  this.maxRows = M,
  ...
  (function (t, e) {
    ...
    const L = {
        ...
        off(t, e, i, n) {
          ...
          if (void 0 !== o) {
            if (!l || !l[r]) return;
            return void M(t, l, r, o, s ? i : null);
          }
          h &&
            Object.keys(l).forEach((i) => {
              !(function (t, e, i, n) {
                ...
                Object.keys(s).forEach((o) => {
                  if (o.includes(n)) {
                    const n = s[o];
                    M(t, e, i, n.originalHandler, n.delegationSelector);
                  }
                });
              })(t, l, i, e.slice(1));
            });
          ...
          if (x) {
            if (o || a) {
              var E = "y" === y ? gt : _t,
                ...
                j = R[S],
                F = oe(0, C[A], W[A]),
                q = b ? C[A] / 2 - M - F - z - T : N - F - z - T,
                B = b ? -C[A] / 2 + M + F + j + T : L + F + j + T,
                ...
                K = x[y] + B - U;
              if (o) {
                var V = oe(p ? ne(P, $) : P, I, p ? ie(O, K) : O);
                (x[y] = V), (D[y] = V - I);
              }
              if (a) {
                var G = "x" === y ? gt : _t,
    ...
    var je = ze(),
      Fe = ze({ defaultModifiers: [fe, Me, de, Yt] }),
      qe = ze({ defaultModifiers: [fe, Me, de, Yt, Oe, Se, Ne, le, Pe] });
